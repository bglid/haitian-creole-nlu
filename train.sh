...
python3 ./models/run_flaubert.py --data_dir=./models/Data/MCTest160/ --output_dir=./models/outputs/FLAUBERT/ --learning_rate=1e-5 --weight_decay=0.01 --num_epochs=20 --action=train
