...
# # FLAUBERT
python3 ./models/run_flaubert.py --data_dir=./models/Data/MCTestHat1/ --output_dir=./models/outputs/FLAUBERT/ --learning_rate=1e-5 --weight_decay=0.01 --num_epochs=10 --action=evaluate --from_checkpoint=./models/outputs/FLAUBERT/checkpoint-245
python3 ./models/run_flaubert.py --data_dir=./models/Data/MCTestHat2/ --output_dir=./models/outputs/FLAUBERT/ --learning_rate=1e-5 --weight_decay=0.01 --num_epochs=10 --action=evaluate --from_checkpoint=./models/outputs/FLAUBERT/checkpoint-245

# # FLAUBERT true zero-shot
# python3 ./models/run_flaubert.py --data_dir=./models/Data/MCTestHat1/ --output_dir=./models/outputs/FLAUBERT/ --learning_rate=1e-5 --weight_decay=0.01 --num_epochs=10 --action=evaluate
# python3 ./models/run_flaubert.py --data_dir=./models/Data/MCTestHat2/ --output_dir=./models/outputs/FLAUBERT/ --learning_rate=1e-5 --weight_decay=0.01 --num_epochs=10 --action=evaluate
