...
def parse_args():
    ...
    parser.add_argument(
        "--tokenizer", type=str, default="flaubert/flaubert_base_uncased"
    )
    parser.add_argument(
        "--from_pretrained", type=str, default="flaubert/flaubert_base_uncased"
    )
...
def main():
    ...
    if args.action == "train":
        ...
        # trying a real zero-shot, no transfer learning!
        # model = AutoModelForMultipleChoice.from_pretrained(args.from_pretrained).to(
        #     device
        # )
